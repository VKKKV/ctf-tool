...
if cmd == "encode":
    ...
    if debug:
        plt.subplot(235), plt.imshow(bgr_to_rgb(rwm)), plt.title("encrypted(watermark)")
        plt.xticks([]), plt.yticks([])
    ...
    if debug:
        plt.subplot(232), plt.imshow(bgr_to_rgb(np.real(f1))), plt.title("fft(image)")
        plt.xticks([]), plt.yticks([])
    ...
    if debug:
        (
            plt.subplot(233),
            plt.imshow(bgr_to_rgb(np.uint8(img_wm))),
    ...
    if debug:
        ...
        (
            plt.subplot(235),
            plt.imshow(bgr_to_rgb(np.real(f1))),
    ...
    if debug:
        plt.subplot(233), plt.imshow(bgr_to_rgb(rwm)), plt.title("encrypted(watermark)")
        plt.xticks([]), plt.yticks([])
